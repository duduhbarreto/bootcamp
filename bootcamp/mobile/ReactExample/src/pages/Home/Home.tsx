import { SafeAreaView, View, Text, FlatList, Dimensions, TouchableOpacity, Modal, ScrollView } from "react-native";
import { styles } from "./styles";
import CustomButton from "../../components/CustomButton/CustomButton";
import { useTypedNavigation } from "../../hooks/useTypedNavigation";
import { CaretLeft, House, SignOut } from "phosphor-react-native";
...
const routes = [
    ...
    { name: 'Count', title: 'Count Route', description: 'Component Count' },
    { name: 'Carousel', title: 'Carousel Route', description: 'Component Carousel' },
    { name: 'FormElements', title: 'FormElements Route', description: 'Component FormElements' },
]
